...
let favoriteFoods = ['french toast', 'pizza', 'tamales','salmon'];
...
let numOfAnimals = animalArray.length
console.log('Number of animals:', numOfAnimals)
...
console.log('Added an entree to: ${favoriteFoods}');
